    ...
    <div class="min-h-screen py-32 px-10">
            ...
            <form method="POST" action="/screenshooter/create">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="url" name="url" placeholder="Enter URL"
                        class="border border-gray-300 w-full p-3 rounded shadow sm:border-blue-500">
                    @error('url')
        ...
        <div class="p-10 rounded-lg shadow md:w-3/4 mx-auto lg:w-1/2 mt-10 border-dashed border-2 border-white">
            ...
            <a href="{{$url ?? '#'}}" target="_blank"
                class="block w-full bg-blue-500 text-white font-bold p-4 rounded mt-4 text-center">See in new tab</a>
            @else
